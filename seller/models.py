...
class Languages(models.Model):
    profile = models.ForeignKey(Personal_Info, models.CASCADE, blank=True, null=True)
    language = models.CharField(max_length=70, null=True, blank=True)
    Language_Levels = models.ForeignKey(Language_Levels, models.CASCADE)
...
class Occupation(models.Model):
    profile = models.ForeignKey(Personal_Info, models.CASCADE, blank=True, null=True)
    occupation = models.ForeignKey(Occupation_list, models.CASCADE)
...
class Skill(models.Model):
    profile = models.ForeignKey(Personal_Info, models.CASCADE, blank=True, null=True)
    skills = models.ForeignKey(Skill_list, models.CASCADE)
